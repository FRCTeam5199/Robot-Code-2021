...
public class Turret{
    ...
    public void updateSimple(){
        if(panel.get(ControllerEnums.ButtonPanelButtons.BUDDY_CLIMB) == ControllerEnums.ButtonStatus.DOWN){
            motor.set(rotSpeed.getDouble(0));
        }
    ...
    public void update(){
        ...
        */
        ...
        if(/*panel.getButton(12)*/joy.get(ControllerEnums.JoystickButtons.TWO) == ControllerEnums.ButtonStatus.DOWN){
            omegaSetpoint = joy.get(ControllerEnums.JoystickAxis.X_AXIS)*2;
        }
    ...
    public void init(){
        ...
        double versaRatio = RobotNumbers.TURRET_GEAR_RATIO;
        double turretSprocketSize = RobotNumbers.TURRET_SPROCKET_SIZE;
        double motorSprocketSize = RobotNumbers.MOTOR_SPROCKET_SIZE;
